...
const initialCards: SporteinlagenCard[] = [
    {
        id: 1,
        name: 'Sporteinlage Standard',
...
export default function Sporteinlagen() {
    ...
    const [cards, setCards] = useState<SporteinlagenCard[]>(initialCards);
    ...
    const handleEditClick = (card: SporteinlagenCard) => {
        setForm({
            name: card.name,
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        setForm({
            name: '', rohlingHersteller: '', artikelHersteller: '', artNr: '', versorgung: '', materialien: '', laenge: '',
        });
        setOpen(false);
    };
    ...
    return (
        <div className='flex flex-col gap-4 mt-10'>
            <h1 className='text-2xl font-bold'>Sporteinlagen</h1>
