...
const initialCards: AlltagseinlagenCard[] = [
    {
        id: 1,
        name: 'Standard Einlage',
...
export default function Alltagseinlagen() {
    ...
    const [cards, setCards] = useState<AlltagseinlagenCard[]>(initialCards);
    ...
    return (
        <div className='flex flex-col gap-4 mt-10'>
            <h1 className='text-2xl font-bold'>Alltagseinlagen</h1>
