...
interface SporteinlagenCard extends VersorgungCard { }
...
export default function Sporteinlagen() {
    ...
    const [cards, setCards] = useState<SporteinlagenCard[]>([]);
    const [modalOpen, setModalOpen] = useState(false);
    const [editingCard, setEditingCard] = useState<SporteinlagenCard | null>(null);
