...
interface AddNewScanningModalProps {
    isOpen: boolean
    onClose: () => void
    customerId: string
    onSubmit?: () => void
...
export default function AddNewScanningModal({ 
    isOpen, 
    onClose, 
    customerId, 
    onSubmit 
}: AddNewScanningModalProps) {
    const {
        filePreviews,
        isSubmitting,
        handleFileUpload,
    ...
    }, [isOpen, resetForm]) // Now safe to include resetForm since it's memoized
